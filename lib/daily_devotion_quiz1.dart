...
import 'package:bible_journey/daily_devotion_quiz2.dart';

class DailyDevotionQuiz1 extends StatefulWidget {
  final int selectedOption;

  const DailyDevotionQuiz1({super.key, required this.selectedOption});

  @override
  State<DailyDevotionQuiz1> createState() => _DailyDevotionQuiz1State();
}

class _DailyDevotionQuiz1State extends State<DailyDevotionQuiz1> {
